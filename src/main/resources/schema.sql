...
CREATE TABLE cars (
                      ...
                      year_of_manufacture DATE NOT NULL,          -- Год выпуска, обязательное поле
...
-- Создание таблицы employee_statuses (Статусы сотрудников)
CREATE TABLE employee_statuses (
                                   id BIGSERIAL PRIMARY KEY,               -- ID статуса сотрудника
                                   status_name VARCHAR(35) NOT NULL UNIQUE -- Наименование статуса сотрудника, обязательное и уникальное поле
);
...
CREATE TABLE positions (
                           ...
                           position_name VARCHAR(35) NOT NULL UNIQUE -- Наименование должности, обязательное и уникальное поле
);
...
CREATE TABLE employees (
                           ...
                           account_id BIGINT NOT NULL,                         -- ID учётной записи, обязательное поле
                           position_id BIGINT NOT NULL,                        -- ID должности, обязательное поле
                           employment_status_id BIGINT NOT NULL,               -- ID трудового статуса, обязательное поле
    ...
    -- Внешний ключ на таблицу employee_statuses
